...
const COORDINADOR_CALIDAD = 'COORDINADOR_CALIDAD';

const ROLES_OPERACION_LECTURA = [
    ADMIN,
    JEFE_LINEA,
    JEFE_PRODUCCION,
    JEFE_PLANTA,
...
const ROLES_RECEPCION_LECHE_LECTURA = [
    ADMIN,
    JEFE_LINEA,
    JEFE_PRODUCCION,
    JEFE_PLANTA,
...
const ROLES_OPERACION_ESCRITURA = [
    ADMIN,
    JEFE_LINEA
];

const ROLES_PROGRAMACION_ESCRITURA = [
    JEFE_PRODUCCION
];

const ROLES_CATALOGOS_TECNICOS = [
    ADMIN,
    JEFE_PRODUCCION,
    JEFE_PLANTA,
    DUENO_EMPRESA
