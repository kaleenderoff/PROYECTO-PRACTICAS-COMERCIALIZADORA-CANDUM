...
@Service
public class ReporteLacteoService {
    ...
    public ReporteConsumoInsumosLacteoResponse consultarConsumoInsumos(LocalDate fecha) {
    ...
    @Transactional(readOnly = true)
    public ReporteRecepcionDescremadoLacteoResponse consultarRecepcionDescremado(LocalDate fecha) {
        LocalDate fechaConsulta = fecha != null ? fecha : LocalDate.now();
